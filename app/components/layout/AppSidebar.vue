<template>
  <div class="list-group">
    <NuxtLink to="/dashboard" class="list-group-item list-group-item-action"
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-speedometer2 me-2"
        viewBox="0 0 16 16">
        <path
    ...
    <NuxtLink v-if="user?.role === 'peneliti'" to="/projects" class="list-group-item list-group-item-action"
      :class="{ active: activeItem === 'projects' }">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-folder me-2"
        viewBox="0 0 16 16">
        <path
    ...
    <a href="#" class="list-group-item list-group-item-action" :class="{ active: activeItem === 'surveys' }">
    ...
    <a href="#" class="list-group-item list-group-item-action" :class="{ active: activeItem === 'analytics' }">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bar-chart me-2"
        viewBox="0 0 16 16">
        <path
